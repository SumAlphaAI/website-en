      ...
      <div className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="space-y-12">
          <div className="border-b border-[color:var(--line)] pb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-[color:var(--foreground)] mb-4">SumAlpha Terms of Service</h1>
          ...
          <div className="space-y-8 text-lg text-[color:var(--muted)] leading-relaxed">
            <section>
              <h2 className="text-2xl font-bold text-[color:var(--foreground)] mb-4">1. Acceptance of Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[color:var(--foreground)] mb-4">2. Description of Service</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[color:var(--foreground)] mb-4">3. User Responsibilities &amp; Security</h2>
              <div className="bg-[color:var(--panel-2)] rounded-xl p-6 border border-[color:var(--line)] space-y-4">
                <div>
                  <h3 className="text-xl font-semibold text-[color:var(--foreground)] mb-2">Self-Custody (SumAlpha Basic)</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-xl font-semibold text-[color:var(--foreground)] mb-2">Platform Authorization (SumAlpha Pro)</h3>
                  <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[color:var(--foreground)] mb-4">4. Risks &amp; Disclaimers</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[color:var(--foreground)] mb-4">5. Fees &amp; Payments</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[color:var(--foreground)] mb-4">6. Modifications to Service</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[color:var(--foreground)] mb-4">7. Contact Information</h2>
              <p>
                For any questions regarding these Terms, please contact us at <span className="text-[color:var(--accent)]">hello@sumalpha.ai</span>.
              </p>
            </section>
          </div>
        </div>
