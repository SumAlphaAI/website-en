      ...
      <div className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="space-y-12">
          <div className="border-b border-[color:var(--line)] pb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-[color:var(--foreground)] mb-4">SumAlpha Privacy Policy</h1>
            <p className="text-xl text-[color:var(--muted)]">Last updated: February 2026</p>
          </div>

          <div className="space-y-8 text-lg text-[color:var(--muted)] leading-relaxed">
            <section>
              <h2 className="text-2xl font-bold text-[color:var(--foreground)] mb-4">1. Introduction</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[color:var(--foreground)] mb-4">2. Architecture &amp; Data Security</h2>
              <p className="mb-4">
              ...
              <div className="bg-[color:var(--panel-2)] rounded-xl p-6 border border-[color:var(--line)] space-y-4">
                <div>
                  <h3 className="text-xl font-semibold text-[color:var(--foreground)] mb-2">SumAlpha Desktop APP</h3>
                  <p>
                ...
                <div className="w-full h-px bg-[color:var(--line)] my-4" />
                
                <div>
                  <h3 className="text-xl font-semibold text-[color:var(--foreground)] mb-2">SumAlpha Pro Platform</h3>
                  <p>
                  ...
                  <ul className="list-disc pl-5 mt-2 space-y-1 text-[color:var(--muted)]">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[color:var(--foreground)] mb-4">3. Data Collection</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[color:var(--foreground)] mb-4">4. How We Use Your Information</h2>
              <p>We use the collected data to:</p>
              <ul className="list-disc pl-5 mt-2 space-y-2 text-[color:var(--muted)]">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[color:var(--foreground)] mb-4">5. Third-Party Integration</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[color:var(--foreground)] mb-4">6. Contact Us</h2>
              <p>
                If you have any questions about this Privacy Policy, please contact us at <span className="text-[color:var(--accent)]">hello@sumalpha.ai</span>.
              </p>
            </section>
          </div>
        </div>
